/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 84fcaaf69c177028fc53415598db698b)
...
interface __BaseEnv_CloudflareEnv {
	...
	DB: D1Database;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://sistema-administrativo-epic.dennis-cc7.workers.dev";
	RESEND_FROM: "Epic Adventures <no-reply@epicadventurescr.com>";
	NEXT_INC_CACHE_KV_PREFIX: "inc";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "RESEND_FROM" | "NEXT_INC_CACHE_KV_PREFIX" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY">> {}
}
